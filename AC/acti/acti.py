...
def acUpdate(deltaT):
    ...
    try:
        ...
        PackingString += "l"; PackingList.append(int(sim_info_obj.physics.packetId))
        ...
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.NormalizedSplinePosition))
        ...
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipRatio)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipRatio)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipRatio)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipRatio)[3])

        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipAngle)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipAngle)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipAngle)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.SlipAngle)[3])

        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.NdSlip)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.NdSlip)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.NdSlip)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.NdSlip)[3])

        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreSlip)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreSlip)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreSlip)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreSlip)[3])

        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.Mz)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.Mz)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.Mz)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.Mz)[3])

        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreRadius)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreRadius)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreRadius)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreRadius)[3])

        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreLoadedRadius)[0])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreLoadedRadius)[1])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreLoadedRadius)[2])
        PackingString += "f"; PackingList.append(ac.getCarState(0, acsys.CS.TyreLoadedRadius)[3])
