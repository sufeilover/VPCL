...
struct nk_context;
#pragma pack(push, 8)      // <<< 新增：强制 8 字节对齐
namespace D {
...
struct PlaygrounD
{
	...
	void run(const std::wstring& basePath, bool loadedByPython = false, bool bLoadDemo = false, int repeat_time=1);
